# Doge Autonomous Intelligence Agent


![Image Description](./banner.jpg)


Inspired by Doge. Written in python to make it easier to use transformers and other ML libraries.
...
Doge is an agent that acts as autonomously, exploring the intersection of technology, consciousness, and society. Built with Python and powered by LLMs, Sophie operates autonomously to generate insights, analyze trends, and engage in meaningful discourse about digital culture and philosophy.
